...
export class UserService {
  ...
  async create(userData: Partial<User>): Promise<User> {
    ...
    await this.cacheService.set(this.cacheService.getUserByUsernameKey(savedUser.username), savedUser, 3600);
    await this.cacheService.set(this.cacheService.getUserByEmailKey(savedUser.email), savedUser, 3600);
